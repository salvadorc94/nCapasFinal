...
<div class="card">
<div class="center"><br>
<input type="button" class="btn btn-info" value="Crear Pelicula" onclick="location.href='${pageContext.request.contextPath}/createP?cu=${usuario.pkidusuario}'"/>
<div class="btn-group">
...
<div class="table-responsive center">          
    	...
    	<tbody>
        		<c:forEach items="${peliculas}" var="peli">
        			<tr>
        			<td>
  						<input type="button" class="btn btn-primary" value="Editar" onclick="location.href='${pageContext.request.contextPath}/editP?c=${peli.pkidpelicula}&cu=${usuario.pkidusuario}'"/>
        			</td>	
        			<td>${peli.nombre}</td>
        			<td>${peli.estadoDelegate}</td>
        			<td>${peli.fechacreacion}</td>
        			<td>${peli.usuariocreacion}</td>
        			<td>${peli.fechamodificacion}</td>
        			<td>${peli.usuariomodificacion}</td>
        			</tr>
        		</c:forEach>
    	</tbody>
  		</table>
